...
class macs2(Tool):  # pylint: disable=invalid-name
    ...
    def macs2_peak_calling(name, bam_file, narrowpeak_file, summits_bed, broadpeak_file, gappedpeak_file ):
    ...
    def run(self, input_files, input_metadata, output_files):
        ...
        results = self.test_writer(
            ...
            output_files["_peaks.narrowPeak"]
            output_files["_peaks.broadPeak"]
            output_files["_peaks.gappedPeak"]
            output_files["_summits.bed"]
        )
        ...
        output_metadata = {
            {
                ...
                data_type="<chipSeq>",
                file_type="bed",
                file_path=output_files["_peaks.narrowPeak"],
             ...
             },  
             {
                ...
                data_type="<chipSeq>",
                file_type="bed",
                file_path=output_files["_peaks.broadPeak"],
                sources=[input_metadata["input"].file_path],
                taxon_id=input_metadata["input"].taxon_id,
                meta_data={
                    "tool": "testTool"
             ...
             },
             {
                ...
                data_type="<chipSeq>",
                file_type="bed",
                file_path=output_files["_peaks.gappedPeak"],
                sources=[input_metadata["input"].file_path],
                taxon_id=input_metadata["input"].taxon_id,
                meta_data={
                    "tool": "testTool"
             ...
             },
             {
                ...
                data_type="<chipSeq>",
                file_type="bed",
                file_path=output_files["_summits.bed"],
                sources=[input_metadata["input"].file_path],
                taxon_id=input_metadata["input"].taxon_id,
                meta_data={
                    "tool": "testTool"
        ...
        macs2_peak_calling ("athina", input_files["bam_file"], output_files["_peaks.narrowPeak"], output_files["_summits.bed"], output_files["_peaks.broadPeak"], output_files["_peaks.gappedPeak"] )
